...
There are `r nrow(distinct(brfss_df, locationdesc))` unique locations. There are `r nrow(distinct(brfss_df, locationabbr))` unique states. Every state is represented and Washington DC is also included. 
